...
public class tafsiribnkathir_alfalaq extends Activity{
	...
	public void onCreate(Bundle bundle){
		...
		webview = (WebView) findViewById(R.id.webview1);
		 ...
		 String content = ambilResource(getResources(),R.raw.tafsiribnkathir_alfalaq);
	...
	private void showActionBar() {
        ...
        bar.setTitle(R.string.tafsir_alfalaq);
